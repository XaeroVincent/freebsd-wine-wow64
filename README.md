...
## Known Issues:
* 32-bit WineD3D performance is extremely poor. Please use Damavand with `WINE_D3D_CONFIG="renderer=vulkan"`, DXVK, D7VK, or the Zink (OpenGL on Vulkan) Mesa driver for impacted 32-bit applications.
